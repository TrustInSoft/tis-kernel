...
module Keep_unused_static_functions: Parameter_sig.Bool
(** Behavior of option "-keep-unused-static-functions". *)
...
module AggressiveMerging: Parameter_sig.String
(** Behavior of option "-aggressive-merging" *)

module InliningMode: Parameter_sig.String
(** Behavior of option "-inlining-mode" *)
...
module Language: Parameter_sig.String
(** Behavior of option "-language" *)
...
module AddressAlignment: Parameter_sig.Int
(** Behavior of option "-address-alignment" *)

module AbsoluteValidRange: Parameter_sig.String
(** Behavior of option "-absolute-valid-range" *)

module VolatileGlobals: Parameter_sig.String_set
(** Behavior of option "-volatile-globals" *)
