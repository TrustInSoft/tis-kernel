...
struct
  ...
  let () = Ast.add_monotonic_state HptmapStmtBool.self
...
let () = Ast.add_monotonic_state StmtCanReachCache.self
...
let () = Ast.add_monotonic_state StmtsGraphTbl.self
...
let () = Ast.add_monotonic_state Reachable_Stmts.self
...
let () = Ast.add_monotonic_state StmtStmts.self
