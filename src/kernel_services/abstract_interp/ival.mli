...
val overlap : t -> Integer.t -> int -> int -> bool
(** [overlap ival size offset offset_size] checks if an overlap exists between
    the inverval \[offset; offset + offset_size - 1\] and [ival] and its
    associated size. *)
