...
module Location_Bytes : sig
  ...
  (** [fold_enum f loc acc] enumerates the locations in [loc], and passes
...
val reduce_offset_by_validity :
  for_writing:bool -> ?bitfield:bool -> Base.t -> Ival.t -> Int_Base.i -> Ival.t
