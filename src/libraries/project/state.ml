...
type private_ops =
  { mutable descr: Structural_descr.pack;
    create: Project_skeleton.t -> unit;
    remove: Project_skeleton.t -> unit;
    mutable clear: Project_skeleton.t -> unit;
    mutable clear_some_projects:
      (Project_skeleton.t -> bool) -> Project_skeleton.t -> bool;
    copy: Project_skeleton.t -> Project_skeleton.t -> unit;
    commit: Project_skeleton.t -> unit;
    update: Project_skeleton.t -> unit;
    on_update: (unit -> unit) -> unit;
    clean: unit -> unit;
    serialize: Project_skeleton.t -> state_on_disk;
    unserialize: Project_skeleton.t -> state_on_disk -> unit }
