...
module HistoryElt = struct
  ...
  let in_same_fun e1 e2 =
    let f = function
      | Global (GFunDecl (_, vi, _) | GFun ({svar = vi; _}, _)) ->
...
let translate_history_elt old_helt =
  ...
  let global old_g =
    let iter new_g =
      ...
      match old_g,
            new_g with
      | (GType(                      {torig_name = old_name; _},          old_loc),
         GType(                      {torig_name = new_name; _},          new_loc))
      | (GEnumTag(                   {eorig_name = old_name; _},          old_loc),
         GEnumTag(                   {eorig_name = new_name; _},          new_loc))
      | (GEnumTagDecl(               {eorig_name = old_name; _},          old_loc),
         GEnumTagDecl(               {eorig_name = new_name; _},          new_loc))
      | (GCompTag(                   {corig_name = old_name; _},          old_loc),
         GCompTag(                   {corig_name = new_name; _},          new_loc))
      | (GCompTagDecl(               {corig_name = old_name; _},          old_loc),
         GCompTagDecl(               {corig_name = new_name; _},          new_loc))
      | (GVarDecl(                     {vorig_name = old_name; _},          old_loc),
         GVarDecl(                     {vorig_name = new_name; _},          new_loc))
      | (GFunDecl(_,                 {vorig_name = old_name; _},          old_loc),
         GFunDecl(_,                 {vorig_name = new_name; _},          new_loc))
      | (GVar(                       {vorig_name = old_name; _},_,        old_loc),
         GVar(                       {vorig_name = new_name; _},_,        new_loc))
      | (GFun({svar=                 {vorig_name = old_name; _}; _},         old_loc),
         GFun({svar=                 {vorig_name = new_name; _}; _},         new_loc))
      | (GAnnot(Dtype(                  {lt_name = old_name; _},_),       old_loc),
         GAnnot(Dtype(                  {lt_name = new_name; _},_),       new_loc))
      ...
      | (GAnnot(Dfun_or_pred({l_var_info= {lv_name=old_name; _}; _},_),      old_loc),
         GAnnot(Dfun_or_pred({l_var_info= {lv_name=new_name; _}; _},_),      new_loc))
