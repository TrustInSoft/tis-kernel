...
val tis_logo: GdkPixbuf.pixbuf option
val tis_icon: GdkPixbuf.pixbuf option
...
module Icon: sig
  ...
  (** Generic icons available in every proper install of TrustInSoft Kernel.
  ...
  (** [register ~name ~file] registers the kind [Custom name] associated
      ...
      [$TIS_KERNEL_SHARE/f] should point to an existing file containing
  ...
  (** @return the pixbuf associated to the given kind.
      ...
      [$(TIS_KERNEL_SHARE)/f] is not a real image file loadable by GdkPixbuf,
