...
module AbortOnPointerLibraryFunction: Parameter_sig.Bool
...
module WholeProgramGraph: Parameter_sig.Bool

module WarnLeftShiftNegative: Parameter_sig.Bool
module WarnPointerSubstraction: Parameter_sig.Bool
module WarnHarmlessFunctionPointer: Parameter_sig.Bool
module WarnPointerArithmeticOutOfBounds: Parameter_sig.Bool
module WarnVaArgTypeMismatch: Parameter_sig.Bool
...
module TotalPtrComparison : Parameter_sig.Bool
...
module CloneOnRecursiveCalls: Parameter_sig.Bool
