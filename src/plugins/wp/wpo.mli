...
sig
  val cache_log : pid:prop_id -> model:Model.t ->
    prover:VCS.prover -> result:VCS.result -> string
  val pretty : pid:prop_id -> model:Model.t ->
    prover:VCS.prover -> result:VCS.result -> Format.formatter -> unit
  val file_kf :
    kf:kernel_function -> model:Model.t -> prover:VCS.prover -> string
  val file_goal : pid:prop_id -> model:Model.t -> prover:VCS.prover -> string
  val file_logout : pid:prop_id -> model:Model.t -> prover:VCS.prover -> string
  val file_logerr : pid:prop_id -> model:Model.t -> prover:VCS.prover -> string
end
...
sig
  ...
  val is_trivial : t -> bool
  val cache_descr : t -> (VCS.prover * VCS.result) list -> string
...
sig
  ...
  val resolve : t -> bool
  val is_trivial : t -> bool
  val cache_descr : pid:prop_id -> t -> (VCS.prover * VCS.result) list -> string
...
val get_file_logout : t -> VCS.prover -> string (** only filename, might not exists *)
val get_file_logerr : t -> VCS.prover -> string (** only filename, might not exists *)
