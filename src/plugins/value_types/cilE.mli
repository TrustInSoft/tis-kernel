...
val warn_call_fun_on_unspecified : (unit -> unit) -> warn_mode
(** Do not emit any message but call the function argument if uninitialized
    memory or dangling pointers are found. *)
