...
// This file is systematically included by TrustInSoft Kernel.
// TIS-Kernel's code normalization can use some of the functions declared here.
...
/*@ assigns \nothing; */
void __tis_std_terminate(void)  __attribute__((FC_BUILTIN, noreturn)) ;
