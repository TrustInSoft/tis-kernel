...
#error "TrustInSoft Kernel: This file shall not be directly included"
#endif
...
/* stdatomics.h */
#define __TIS_ATOMIC_BOOL_LOCK_FREE 2
#define __TIS_ATOMIC_CHAR_LOCK_FREE 2
#define __TIS_ATOMIC_CHAR16_T_LOCK_FREE 2
#define __TIS_ATOMIC_CHAR32_T_LOCK_FREE 2
#define __TIS_ATOMIC_WCHAR_T_LOCK_FREE 2
#define __TIS_ATOMIC_SHORT_LOCK_FREE 2
#define __TIS_ATOMIC_INT_LOCK_FREE 2
#define __TIS_ATOMIC_LONG_LOCK_FREE 2
#define __TIS_ATOMIC_LLONG_LOCK_FREE 2
#define __TIS_ATOMIC_TEST_AND_SET_TRUEVAL 1
#define __TIS_ATOMIC_POINTER_LOCK_FREE 2
