...
/* POSIX: All values shall be distinct */
#define SO_ACCEPTCONN   0x0002          /* socket has had listen() */
#define SO_BROADCAST    0x0020          /* permit sending of broadcast msgs */
#define SO_DEBUG        0x0001          /* turn on debugging info recording */
#define SO_DONTROUTE    0x0010          /* just use interface addresses */
#define SO_ERROR        0x1000          /* socket error status */
#define SO_KEEPALIVE    0x0008          /* keep connections alive */
#define SO_LINGER       0x0080          /* linger on close if data present */
#define SO_OOBINLINE    0x0100          /* leave received OOB data in line */
#define SO_RCVBUF       0x0030          /* receive buffer size */
#define SO_RCVLOWAT     0x0031          /* receive ``low water mark'' */
#define SO_RDVTIMEO     0x0032          /* receive timeout */
#define SO_REUSEADDR    0x0004          /* allow local address reuse */
#define SO_SNDBUF       0x0050          /* send buffer size */
#define SO_SNDLOWAT     0x0051          /* send ``low water mark'' */
#define SO_SNDTIMEO     0x0052          /* send timeout */
#define SO_TYPE         0x0060          /* socket type */
/* Non-POSIX values, still keep the values distinct */
...
/* POSIX: All values shall be distinct and bitwise-.
...
#define MSG_EOR         4       /* Terminates a record */
#define MSG_OOB         8       /* Out-of-band data */
#define MSG_NOSIGNAL    16      /* No SIGPIPE generated */
