...
/*@
  requires __locale == \null || valid_read_string(__locale);
  assigns __frama_c_locale \from category, __locale[..];
  assigns \result \from __frama_c_locale,category, __locale[..];
  ensures \result==\null
   || (\valid(\result)
      && \exists ℤ i ; \result == __frama_c_locale_names[i]) ;
*/
extern char *setlocale(int category, const char *__locale);
...
/*@ assigns \result \from __locale; */
locale_t duplocale(locale_t __locale);

/*@ assigns \nothing; */
void freelocale(locale_t locale);

locale_t newlocale(int n, const char *c, locale_t __locale);
locale_t uselocale(locale_t __locale);
